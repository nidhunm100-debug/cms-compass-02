          ...
          <Rise delay={90} className="min-w-0">
            ...
            <p className="mt-8 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
              {map["about"]?.subheading ||
                ...
                "Limra Academy for Excellence designs and delivers workshops for schools, universities,教育 institutions and organisations. Every session is built around techniques participants can practise in the room and use immediately afterwards."}
            </p>
            <div className="mt-10">
